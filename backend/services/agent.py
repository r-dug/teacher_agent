...
class BackendAgentSession:
    ...
    def __init__(
        ...
        self.agent = TeachingAgent(
            ...
            decompose_llm_provider=decompose_llm_provider,
            decompose_llm_model=decompose_llm_model,
            openai_api_key=openai_api_key,
            openai_timeout_seconds=openai_timeout_seconds,
            openai_max_retries=openai_max_retries,
            openai_decompose_timeout_seconds=openai_decompose_timeout_seconds,
            openai_decompose_max_retries=openai_decompose_max_retries,
            openai_decompose_max_input_chars=openai_decompose_max_input_chars,
